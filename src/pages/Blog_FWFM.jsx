...
const FWFM = () => {
    ...
    return (
        ...
        <a href="https://fractals.blackfeministfuture.org/">Fractals a Black Feminist Timeline</a>
        <a href="http://heresiesfilmproject.org/archive/">The Heresies Magazine 1977-1993</a>
            <div className="red" style={{ paddingBottom: "5px" }}>
