...
const TRMR = () => {
    ...
    return (
        <PageLayout>
            ...
            <p>I joined social media through a Tumblr account in my early teens, which I used as my primary social media platform for many years. In retrospect, I primarily used social media for exploration - of ideas, aesthetics, worldviews, lifestyles - of anything that I wouldn't have thought to Google.</p>
