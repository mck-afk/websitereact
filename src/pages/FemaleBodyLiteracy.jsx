    ...
    <div id="noticeboard">
        ...
        >
          <ul style={{"listStyleType": "none", margin: 0, padding: 0}}>
            ...
            <li><a href="https://fittedforwork.org/"><img className="icon" src="https://fittedforwork.org/wp-content/uploads/2025/08/Fitted-for-Work_Vertical_Coral.svg" alt="free employment support" /> Free Employment Support, Fitted For Work</a></li>
            <li><a href="https://www.betterhealth.vic.gov.au/chemist-care-now"><img className="icon" src="https://content.dhhs.vic.gov.au/sites/default/files/2025-10/contraceptive-pill-icon-chemist-care-now.png" alt="prescription-free contraception at pharmacy" /> Over the counter contraceptive pill and UTI treatments from July 2026</a></li>
        ...
        >
          <ul style={{"listStyleType": "none", margin: 0, padding: 0}}>
            <li><a href="https://www.arcwoman.com.au/"><img className="icon" src="https://images.squarespace-cdn.com/content/v1/640d9750e3651778e3a40b33/f150c378-3e04-40b1-a477-ede899a4d488/logo+1+transparent.png?format=1500w" alt="Arc Woman" /> Arc Woman Nutrition</a></li>
            
            <li><a href="https://abortiononourownterms.org/"><img className="icon" src="https://abortiononourownterms.org/wp-content/uploads/2023/10/abortion-pills-box-1-1.png" alt="Self Managed Abortion" /> Abortion On Our Own Terms</a></li>
            <li><a href="https://www.fromdayone.com.au/"><img className="icon" src="https://www.fromdayone.com.au/cdn/shop/files/FDO_AppIcon_Olive_1024x1024_4630c824-d985-46bb-bdf5-456d0564f5a6.png?v=1706845975&width=36" alt="From Day One" /> From Day One - female parent support</a></li>
            <li><a href="https://www.raising-fathers.com/"><img className="icon" src="images/raising-fathers.png" alt="Raising Fathers" /> Raising Fathers - male parent support</a></li>
            ...
            <li><a href="https://hagia.de/en/international-academy-hagia"><img className="icon" src="https://hagia.de/typo3conf/ext/kmb_hagia/Resources/Public/Images/Logo-Hagia.png" alt="HAGIA" /> Modern Matriarchal Studies</a></li>
