    ...
    return (
        <PageLayout>
            ...
            <thead>
                ...
                <th style={cellStyle}>Detriment</th>
                </tr>
            </thead>
            <tbody>
                <tr>
                <th style={cellStyle}>Programmers</th>
                <td style={cellStyle}>
                    <ul>
                ...
                <td style={cellStyle}>
                    ...
                    <ol><li><p>grateful—for this stranger, for the gift of their time, attention, and expertise</p></li><li><p>curious—as to their own problems they are trying to solve, and </p></li><li><p>inspired—maybe my time, attention, and expertise could help them!</p></li></ol>
                ...
                <tr>
                <th style={cellStyle}>Corporations</th>
                <td style={cellStyle}>
                    <ul>
